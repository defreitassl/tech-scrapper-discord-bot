...
- [providers-contract.md](./providers-contract.md): contrato para providers de coleta de vagas, incluindo GitHub, APIs externas, Remotar, Gupy, Programathor, ATS publicos e o pipeline automatizado que aprova como `PENDING` ou recusa sem persistir.
