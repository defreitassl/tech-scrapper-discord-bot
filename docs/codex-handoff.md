...
Existe uma base de providers em `src/providers/`, com provider mock/de teste, provider GitHub para issues publicas de repositorios de vagas, providers externos para Himalayas, Jobicy, RemoteOK e Remotive, providers ATS para Greenhouse, Lever e Ashby, e providers experimentais manuais para Gupy e Programathor.
...
- Nao ha scraping HTML real de fontes protegidas, Cheerio, LinkedIn ou Solides nesta etapa. A Gupy existe apenas como provider experimental manual baseado em endpoint publico observado, com limite baixo e fora da coleta automatica. O Programathor existe apenas como provider experimental manual por HTML publico simples, com limite baixo e fora da coleta automatica. Playwright foi usado no reconhecimento e tambem esta instalado como infraestrutura isolada e smoke test nao registrado.
...
- Nao executa `experimentalJobProviders` automaticamente nesta etapa. Isso inclui Gupy e Programathor.
